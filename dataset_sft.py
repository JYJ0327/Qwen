...
class SFTDataset(Dataset):
    def __init__(self,df,tokenizer
        ...
        self.bos=self.tokenizer.added_tokens_encoder['<|im_start|>']
        self.eos=self.tokenizer.added_tokens_encoder['<|im_end|>']
        self.pad=self.tokenizer.pad_token_id#self.tokenizer.special_tokens['<pad>']
